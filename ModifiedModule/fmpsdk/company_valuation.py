...
def revenue_product_by_segments(
    apikey: str, symbol: str, period: str = "annual", limit: int = DEFAULT_LIMIT,
    structure: str = None
) -> typing.Optional[typing.List[typing.Dict]]:
    """
    Query FMP /revenue_product_by_segments/ API.
...
def price_target_consensus(
    ...
    :return: A list of dictionaries.
    """
    path = f"/price-target-consensus?{symbol}"
    query_vars = {
        "apikey": apikey,
        "symbol": symbol,
        "period": __validate_period(value=period),
...
def financial_report_sec_filing(
    apikey: str, symbol: str, year: str, period:str
) -> typing.Optional[typing.List[typing.Dict]]:
    """
    Query FMP /financial-reports-json?/ API.

    :param apikey: Your API key.
    :param symbol: Company ticker.
    :param period: FY, Q1, Q2, Q3, Q4
    :param limit: Number of rows to return.
    :return: A list of dictionaries.
    """
    path = f"/financial-reports-json?{symbol}"
    query_vars = {
        "apikey": apikey,
        "symbol": symbol,
        "year": year,
...
def price_target_summary(
    ...
    :return: A list of dictionaries.
    """
    path = f"/price-target-summary?symbol={symbol}"
    query_vars = {
        "apikey": apikey,
    }
    return __return_json_v4(path=path, query_vars=query_vars)
